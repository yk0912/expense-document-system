...
export const geminiReceiptSchema = z.object({
  ...
  taxAmount8: z.number().nullable().optional(),
  taxAmount10: z.number().nullable().optional(),
  taxableAmount8: z.number().nullable().optional(),
  taxableAmount10: z.number().nullable().optional(),
  taxKind8: z.enum(["included", "excluded"]).nullable().optional(),
  taxKind10: z.enum(["included", "excluded"]).nullable().optional(),
